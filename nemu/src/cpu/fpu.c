...
//printf("%x\n",exp);
	...
	if(!overflow) {
		/* TODO: round up and remove the GRS bits */
			uint64_t temp_grs=sig_grs;
			uint32_t temp_28=((uint32_t)sig_grs << 28) & 0x80000000;//得到GRS前一位
			temp_grs=temp_grs & 0x7;
